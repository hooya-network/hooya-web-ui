export default function Page() {
  return <main>
    ...
    <p>This is a frontend to a private network, offering a demo of the software. HooYa! is not ready for a public deployment, nor is it in a state where it's reliable for daily use. This software is in alpha.</p>
    <h2>What are Tags?</h2>
